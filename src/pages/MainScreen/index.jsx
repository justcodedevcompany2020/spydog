...
import { ArrowRight, DarkActiveSvgButton, DarkRefreshSvg, DarkSvgButton, DownloadSvg, LightActiveSvgButton, LightRefreshSvg, PingSvg, SvgButton, UploadSvg } from "../../../svg"
import { GoPremium } from '../../components/GoPremium'
import { Menu } from '../../components/Menu'
import { NetworkInfoCard } from '../../components/NetworkInfo'
import { Colors } from "../../ui/color"
import { GetCountry } from '../../store/action/action'
...
export const Main = ({navigation}) =>{
    ...
    return <ScrollView showsVerticalScrollIndicator = {false} style = {[Gstyles.main,{marginBottom:0}]}>
        ...
        {!acitve ?
            <Text style = {[Gstyles.text,{color:'#5F719F',textAlign:'center'}]}>Disconnected</Text>:
            <Text style = {[Gstyles.text,{color:Colors(mainData.mood).color,textAlign:'center'}]}>Connected</Text>
        }
       ...
       {!getMyTarife.data?.tariff?.id && <GoPremium onPress = {()=>navigation.navigate('Ad')} />}
