...
import { CheckedSvg, DogLap, NotChecked, PingDark, PinkLight } from "../../../svg"
import { Colors } from "../../ui/color"

export const LocationBlock = ({ title, text, checked, color, onPress, img, premium, type }) => {
    let disablde = !premium && type
    return <TouchableOpacity disabled={disablde > 0} onPress={onPress} style={[styles.block, { backgroundColor: Colors(color).blockBackground }]}>
